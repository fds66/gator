...
func initCommands() (Commands, error) {
	...
	commands.register("reset_posts", (handlerResetPosts))
...
// This adds a feed and registers a follow on the the feed follow table
...
// This adds a follow to the current user in the feed follow table
...
// Adds new feed follow record for a current user
